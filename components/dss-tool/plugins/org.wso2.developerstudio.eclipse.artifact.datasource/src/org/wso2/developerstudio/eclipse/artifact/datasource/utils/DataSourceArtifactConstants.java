 ...
 */
package org.wso2.developerstudio.eclipse.artifact.datasource.utils;
...
public class DataSourceArtifactConstants extends NLS {
	...
	public static final String BUNDLE_NAME = "org.wso2.developerstudio.eclipse.artifact.datasource.utils.datasourceartifactconstants";
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, DataSourceArtifactConstants.class);
	}
	
	public DataSourceArtifactConstants() {
