...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.custom.SingleCompartmentComplexFiguredAbstractMediator;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.ForEachMediatorCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.ForEachMediatorItemSemanticEditPolicy;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.ForEachMediatorTransformer;
...
public class ForEachMediatorEditPart extends SingleCompartmentComplexFiguredAbstractMediator {
     ...
     * @generated
     */
    public static final int VISUAL_ID = 3780;
     ...
     * @generated
     */
    public ForEachMediatorEditPart(View view) {
        super(view);
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ForEachMediatorItemSemanticEditPolicy());
        installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
        installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new FeedbackIndicateDragDropEditPolicy());
        installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ForEachMediatorCanonicalEditPolicy());
        installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());
        // For handle Double click Event.
        installEditPolicy(EditPolicyRoles.OPEN_ROLE, new ShowPropertyViewEditPolicy());
        // XXX need an SCR in runtime to have another abstract superclass that would let children add reasonable
        // editpolicies
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new ForEachMediatorFigure(new Color(null, 239, 187, 63), new Color(null, 255, 255, 255)) {
     ...
     * @generated
     */
    public ForEachMediatorFigure getPrimaryShape() {
        return (ForEachMediatorFigure) primaryShape;
    }
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof ForEachMediatorDescriptionEditPart) {
            ((ForEachMediatorDescriptionEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getFigureForEachMediatorPropertyValue());
            return true;
        }
        ...
        if (childEditPart instanceof ForEachMediatorOutputConnectorEditPart) {
            IFigure borderItemFigure = ((ForEachMediatorOutputConnectorEditPart) childEditPart).getFigure();
            BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
                    PositionConstants.EAST, 0.5);
            getBorderedFigure().getBorderItemContainer().add(borderItemFigure, locator);
            return true;
        }
        if (childEditPart instanceof ForEachMediatorTargetOutputConnectorEditPart) {
            targetOutputConnector = ((ForEachMediatorTargetOutputConnectorEditPart) childEditPart).getFigure();
    ...
    protected boolean removeFixedChild(EditPart childEditPart) {
        ...
        if (childEditPart instanceof ForEachMediatorInputConnectorEditPart) {
            getBorderedFigure().getBorderItemContainer()
                    .remove(((ForEachMediatorInputConnectorEditPart) childEditPart).getFigure());
            return true;
        }
        if (childEditPart instanceof ForEachMediatorOutputConnectorEditPart) {
            getBorderedFigure().getBorderItemContainer()
                    .remove(((ForEachMediatorOutputConnectorEditPart) childEditPart).getFigure());
            return true;
        }
        return false;
    }
    ...
    public EditPart getPrimaryChildEditPart() {
        return getChildBySemanticHint(EsbVisualIDRegistry.getType(ForEachMediatorDescriptionEditPart.VISUAL_ID));
    }

    /**
     * @generated NOT
     */
    public class ForEachMediatorFigure extends EsbGroupingShape {

        /**
         * @generated
         */
        private WrappingLabel fFigureForEachMediatorPropertyValue;
        ...
        private void createContents() {
            ...
            fFigureForEachMediatorPropertyValue.setText(DEFAULT_PROPERTY_VALUE_TEXT);
         ...
         * @generated
         */
        public WrappingLabel getFigureForEachMediatorPropertyValue() {
            return fFigureForEachMediatorPropertyValue;
        }

        public String getIconPath() {
            return FOREACH_MEDIATOR_ICON_PATH;
        }
