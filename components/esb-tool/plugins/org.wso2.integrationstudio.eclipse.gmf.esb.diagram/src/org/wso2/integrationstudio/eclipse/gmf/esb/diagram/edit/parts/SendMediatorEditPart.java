...
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.END_POINT__IN_LINE;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.SendMediatorCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.SendMediatorItemSemanticEditPolicy;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.SendMediatorTransformer;
...
public class SendMediatorEditPart extends SingleCompartmentComplexFiguredAbstractMediator {
    ...
    private void updateEndpointInlineProperty(Notification notification) {
        if (notification.getNewBooleanValue() != notification.getOldBooleanValue()) {
            IGraphicalEditPart mediatorFlow = getChildBySemanticHint(
                    EsbVisualIDRegistry.getType(MediatorFlow19EditPart.VISUAL_ID));
            if (mediatorFlow != null) {
                IGraphicalEditPart mediatorFlowCompartment = mediatorFlow.getChildBySemanticHint(
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        ...
        if (childEditPart instanceof SendMediatorDescriptionEditPart) {
            ((SendMediatorDescriptionEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getFigureSendMediatorPropertyValue());
            return true;
        }
    ...
    public class SendMediatorFigure extends EsbGroupingShape {
         ...
         * @generated NOT
         */
        public SendMediatorFigure(Color bgColor, Color boderColor) {
        ...
        private void createContents() {
            ...
            fFigureSendMediatorPropertyValue.setText(DEFAULT_PROPERTY_VALUE_TEXT);
        ...
        public IFigure getToolTip() {
            if (StringUtils.isEmpty(toolTipMessage)) {
                toolTipMessage = Messages.SendMediatorEditPart_ToolTipMessage;
            }
