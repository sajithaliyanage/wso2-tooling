...
public class EsbPropertySource extends PropertySource {
    ...
    public EsbPropertySource(Object object, IItemPropertySource itemPropertySource) {
    ...
    protected IPropertyDescriptor createPropertyDescriptor(IItemPropertyDescriptor itemPropertyDescriptor) {
        ...
        if (pkg.getLogMediator_Properties().equals(feature)) {
            return new LogConfigurationPropertyDescriptor(object, itemPropertyDescriptor);
           ...
           *//*
            ...
            return new XSLTPropertiesPropertyDescriptor(object, itemPropertyDescriptor);
        } else if (pkg.getXSLTMediator_Resources().equals(feature)) {
            return new XSLTResourcesPropertyDescriptor(object, itemPropertyDescriptor);
        } else if (pkg.getXSLTMediator_Features().equals(feature)) {
            return new XSLTFeaturesPropertyDescriptor(object, itemPropertyDescriptor);
            ...
            return new SwitchConfigurationPropertyDescriptor(object, itemPropertyDescriptor);
        } else if (pkg.getClassMediator_Properties().equals(feature)) {
            return new ClassConfigurationPropertyDescriptor(object, itemPropertyDescriptor);
        ...
        // Throttle Mediator Policy Entries custom property descriptor.
            ...
            return new ScriptKeysPropertyDescriptor(object, itemPropertyDescriptor);
        ...
        // Else, default EMF behavior
            ...
            if (object instanceof CloudConnectorOperation) {
                if (!pkg.getCloudConnectorOperation_ParameterEditorType().equals(feature)
                        && !pkg.getCloudConnectorOperation_ConfigRef().equals(feature)) {
