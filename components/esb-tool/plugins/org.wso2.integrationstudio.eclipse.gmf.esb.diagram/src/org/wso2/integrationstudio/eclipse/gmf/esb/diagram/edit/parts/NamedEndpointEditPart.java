...
public class NamedEndpointEditPart extends ComplexFiguredAbstractEndpoint {
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof NamedEndpointNameEditPart) {
            ((NamedEndpointNameEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getFigureNamedEndPointNamePropertyLabel());
            return true;
        }
    ...
    public void openWithSeparateEditor() {
        ...
        if (!name.equals("")) {
            ...
            /*
             * if ((getEditDomain().getPaletteViewer().getPaletteRoot().getChildren().size() - 1) !=
             * ToolPalleteDetails.DEFINED_ENDPOINT) {
