...
public class RegistryKeyPropertyEditorDialog extends Dialog {
    ...
    protected void openEmbeddedEntryBrowser() {
        hide();
        try {
            EmbeddedEntriesDialog embeddedEntriesDialog = new EmbeddedEntriesDialog(getParentShell(),
                    localNamedEntities);
    ...
    protected void openNewResourceTemplateDialog() {
        ...
        try {
            NewResourceTemplateDialog newResourceTemplateDialog = new NewResourceTemplateDialog(getParentShell(),
                    (Map<String, List<String>>) rkProperty.getFilters());
    ...
    private void openRegistryBrowser() {
        ...
        try {
            ...
            IRegistryData selectedPathData = CAppEnvironment.getRegistryHandler().selectRegistryPath(
                    registryConnections, "Registry Browser", "Select Registry Resource:",
    ...
    private void openRegistryResourceProviderDialog() {
        ...
        try {
            DeveloperStudioElementProviderDialog registryResourceProviderSelector = new DeveloperStudioElementProviderDialog(
                    getParentShell(),
                    new Class[] { IRegistryFile.class, IEsbEndpoint.class, IEsbSequence.class, IEsbLocalEntry.class },
                    (Map<String, List<String>>) rkProperty.getFilters());
