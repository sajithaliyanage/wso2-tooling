...
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.SEQUENCE__NAME;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.SEQUENCE__REFERRING_SEQUENCE_TYPE;
...
import static org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.SEQUENCE_MEDIATOR_ICON_PATH;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.custom.SequenceStorage;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.SequenceCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.SequenceItemSemanticEditPolicy;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.impl.SequenceImpl;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.SequenceMediatorTransformer;
...
public class SequenceEditPart extends FixedSizedAbstractMediator {
    ...
    private static IDeveloperStudioLog log = Logger.getLog("org.wso2.integrationstudio.eclipse.gmf.esb.diagram"); //$NON-NLS-1$
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new SequenceFigure(new Color(null, 255, 255, 255)) {
    ...
    public void openWithSeparateEditor() throws Exception {
        ...
        if (!name.equals("")) { //$NON-NLS-1$
            ...
            /*
             * if ((getEditDomain().getPaletteViewer().getPaletteRoot().getChildren().size() - 2) !=
    ...
    public boolean createAndOpenFile(String name, String fileURI1, String fileURI2, IProject currentProject)
        ...
        if (((Sequence) ((Node) sequenceEditPart.getModel()).getElement()).isReceiveSequence()) {
            ...
            info.setAssociatedProxy(
                    ((ProxyService) ((Node) EditorUtils.getProxy(sequenceEditPart.getParent()).getModel()).getElement())
                            .getName());
        }
        if (!file.exists()) {
    ...
    public class SequenceFigure extends EsbGraphicalShapeWithLabel {
        ...
        public SequenceFigure(Color borderColor) {
             ...
             * "org.wso2.integrationstudio.eclipse.gmf.esb.sequence.diagram.part.EsbDiagramEditorID"
        ...
        public IFigure getToolTip() {
            if (StringUtils.isEmpty(toolTipMessage)) {
                toolTipMessage = Messages.SequenceEditPart_ToolTipMessage;
            }
    ...
    public void moveConnectorsRightSide() {
        ...
        for (int i = 0; i < this.getChildren().size(); ++i) {
            if (this.getChildren().get(i) instanceof AbstractMediatorInputConnectorEditPart) {
                ...
                figureInput.add(
                        ((AbstractMediatorInputConnectorEditPart) this.getChildren().get(i)).getPrimaryShapeReverse());
