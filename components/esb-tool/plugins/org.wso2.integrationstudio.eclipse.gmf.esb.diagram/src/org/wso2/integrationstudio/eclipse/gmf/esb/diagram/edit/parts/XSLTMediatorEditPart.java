...
import static org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.XSLT_MEDIATOR_ICON_PATH;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.XSLTMediatorCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.XSLTMediatorItemSemanticEditPolicy;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.impl.XSLTMediatorImpl;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.XSLTMediatorTransformer;
...
public class XSLTMediatorEditPart extends FixedSizedAbstractMediator {
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new XSLTMediatorFigure(new Color(null, 255, 255, 255)) {
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        ...
        if (childEditPart instanceof XSLTMediatorDescriptionEditPart) {
            ((XSLTMediatorDescriptionEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getXSLTMediatorDescriptionLabel());
            return true;
        }
        if (childEditPart instanceof XSLTMediatorInputConnectorEditPart) {

            IFigure borderItemFigure = ((XSLTMediatorInputConnectorEditPart) childEditPart).getFigure();
            ...
            IFigure borderItemFigure = ((XSLTMediatorOutputConnectorEditPart) childEditPart).getFigure();
            BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
    ...
    public class XSLTMediatorFigure extends EsbGraphicalShapeWithLabel {
        ...
        private void createContents() {
            ...
            fFigureXSLTMediatorPropertyValueLabel.setText(DEFAULT_PROPERTY_VALUE_TEXT);
        ...
        public String getIconPath() {
            return XSLT_MEDIATOR_ICON_PATH;
        }
        ...
        public IFigure getToolTip() {
            if (StringUtils.isEmpty(toolTipMessage)) {
                toolTipMessage = Messages.XSLTMediatorEditPart_ToolTipMessage;
            }
