...
import static org.wso2.integrationstudio.eclipse.gmf.esb.diagram.custom.EditorUtils.TEMPLATE_RESOURCE_DIR;
import static org.wso2.integrationstudio.eclipse.gmf.esb.diagram.custom.EditorUtils.getActiveProject;
import static org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.CALLTEMPLATE_MEDIATOR_ICON_PATH;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.CallTemplateMediatorCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.CallTemplateMediatorItemSemanticEditPolicy;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.impl.CallTemplateMediatorImpl;
...
public class CallTemplateMediatorEditPart extends FixedSizedAbstractMediator {
    ...
    private static IDeveloperStudioLog log = Logger.getLog("org.wso2.integrationstudio.eclipse.gmf.esb.diagram");
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new CallTemplateMediatorFigure(new Color(null, 255, 255, 255)) {
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        ...
        if (childEditPart instanceof CallTemplateMediatorDescriptionEditPart) {
            ((CallTemplateMediatorDescriptionEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getCallTemplateMediatorDescriptionLabel());
            return true;
        }
    ...
    protected boolean removeFixedChild(EditPart childEditPart) {
        ...
        if (childEditPart instanceof CallTemplateMediatorInputConnectorEditPart) {
            getBorderedFigure().getBorderItemContainer()
                    .remove(((CallTemplateMediatorInputConnectorEditPart) childEditPart).getFigure());
            return true;
        }
        if (childEditPart instanceof CallTemplateMediatorOutputConnectorEditPart) {
            getBorderedFigure().getBorderItemContainer()
                    .remove(((CallTemplateMediatorOutputConnectorEditPart) childEditPart).getFigure());
            return true;
        }
        return false;
    }
    ...
    public class CallTemplateMediatorFigure extends EsbGraphicalShapeWithLabel {
        ...
        private void createContents() {
            ...
            fFigureCallTemplateMediatorPropertyValue.setText(DEFAULT_PROPERTY_VALUE_TEXT);
