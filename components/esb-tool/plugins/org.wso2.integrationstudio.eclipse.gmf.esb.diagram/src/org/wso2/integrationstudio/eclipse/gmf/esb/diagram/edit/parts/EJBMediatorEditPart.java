...
import static org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.EJB_MEDIATOR_ICON_PATH;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.EJBMediatorCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.EJBMediatorItemSemanticEditPolicy;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.impl.EJBMediatorImpl;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.EJBMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.custom.EJBMediatorExt;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.custom.EJBMediatorExtSerializer;
...
public class EJBMediatorEditPart extends FixedSizedAbstractMediator {
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new EJBMediatorFigure(new Color(null, 255, 255, 255)) {
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        ...
        if (childEditPart instanceof EJBMediatorDescriptionEditPart) {
            ((EJBMediatorDescriptionEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getEJBMediatorDescriptionLabel());
            return true;
        }
        if (childEditPart instanceof EJBMediatorInputConnectorEditPart) {
            IFigure borderItemFigure = ((EJBMediatorInputConnectorEditPart) childEditPart).getFigure();
        ...
        if (childEditPart instanceof EJBMediatorOutputConnectorEditPart) {
            IFigure borderItemFigure = ((EJBMediatorOutputConnectorEditPart) childEditPart).getFigure();
            BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
    ...
    protected boolean removeFixedChild(EditPart childEditPart) {
        ...
        if (childEditPart instanceof EJBMediatorInputConnectorEditPart) {
            getBorderedFigure().getBorderItemContainer()
                    .remove(((EJBMediatorInputConnectorEditPart) childEditPart).getFigure());
            return true;
        }
        if (childEditPart instanceof EJBMediatorOutputConnectorEditPart) {
            getBorderedFigure().getBorderItemContainer()
                    .remove(((EJBMediatorOutputConnectorEditPart) childEditPart).getFigure());
            return true;
        }
        return false;
    }
    ...
    public class EJBMediatorFigure extends EsbGraphicalShapeWithLabel {
        ...
        private void createContents() {
            ...
            eJBMediatorPropertyValueLabel0.setText(DEFAULT_PROPERTY_VALUE_TEXT);
        ...
        public IFigure getToolTip() {
            if (StringUtils.isEmpty(toolTipMessage)) {
                toolTipMessage = Messages.EJBMediatorEditPart_ToolTipMessage;
            }
