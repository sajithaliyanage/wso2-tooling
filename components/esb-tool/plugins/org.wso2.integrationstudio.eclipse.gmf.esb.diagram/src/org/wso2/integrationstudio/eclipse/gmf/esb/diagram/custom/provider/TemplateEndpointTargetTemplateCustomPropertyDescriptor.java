                    ...
                    try {
                        ...
                        if (element.getFirstChildWithName(new QName(synapseNS, "sequence", null)) != null) {
                            ...
                            DeleteCommand modelDeleteCommand = new DeleteCommand(editingDomain,
                                    ((TemplateEndpoint) object_).getParameters());
                            ...
                            for (TemplateParam parameter : templateMediator.getParameters()) {
                                final TemplateEndpointParameter templateEndpointParameter = EsbFactory.eINSTANCE
                                        .createTemplateEndpointParameter();
                                templateEndpointParameter.setParameterName(parameter.getName());
                            ...
                            org.apache.synapse.endpoints.Template templateEndpoint = templateEndpointFactory
                                    .createEndpointTemplate(element, properties);
                            editingDomain = ((EsbMultiPageEditor) editor).getGraphicalEditor().getEditingDomain();
                            DeleteCommand modelDeleteCommand = new DeleteCommand(editingDomain,
                                    ((TemplateEndpoint) object_).getParameters());
                            if (modelDeleteCommand.canExecute()) {
