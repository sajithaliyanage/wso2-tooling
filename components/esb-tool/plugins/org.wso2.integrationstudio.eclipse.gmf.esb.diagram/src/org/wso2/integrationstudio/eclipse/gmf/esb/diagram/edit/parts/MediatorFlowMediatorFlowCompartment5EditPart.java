...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.MediatorFlowMediatorFlowCompartment5CanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.MediatorFlowMediatorFlowCompartment5ItemSemanticEditPolicy;
...
public class MediatorFlowMediatorFlowCompartment5EditPart extends AbstractMediatorFlowCompartmentEditPart {
    ...
    private <T extends AbstractEndpoint> void addEndpointChildVisual(T childEditPart) {
        borderedNodeFigure.getBorderItemContainer().add(((T) childEditPart).getFigure(), new SlidingBorderItemLocator(
                borderedNodeFigure.getMainFigure(), ((T) childEditPart).getFigure(), PositionConstants.EAST, 10, 5));
    }
    ...
    protected void removeChild(EditPart child) {
        ...
        if (child instanceof AbstractEndpoint) {
            InputConnector connector = (InputConnector) ((Node) EditorUtils
                    .getInputConnector((ShapeNodeEditPart) this.getParent().getParent()).getModel()).getElement();
            ...
            if (inputConnector != null) {
                ...
                ICommand createSubTopicsCmd = new DeferredCreateConnectionViewAndElementCommand(
                        new CreateConnectionViewAndElementRequest(EsbElementTypes.EsbLink_4001,
                                ...
                                sourceEditPart1.getDiagramPreferencesHint()),
                        new EObjectAdapter((EObject) outputConnectorEditPart_.getModel()),
                        new EObjectAdapter((EObject) (inputConnector).getModel()), sourceEditPart1.getViewer());
                ...
                if (outputConnector != null) {
                    ICommand createSubTopicsCmd2 = new DeferredCreateConnectionViewAndElementCommand(
                            ...
                            new EObjectAdapter((EObject) (inputConnectorEditPart_).getModel()),
