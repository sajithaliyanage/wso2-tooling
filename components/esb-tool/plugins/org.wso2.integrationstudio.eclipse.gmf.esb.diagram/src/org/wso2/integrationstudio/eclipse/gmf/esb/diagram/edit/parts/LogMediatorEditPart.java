...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.LogMediatorCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.LogMediatorItemSemanticEditPolicy;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.impl.LogMediatorImpl;
...
public class LogMediatorEditPart extends FixedSizedAbstractMediator {
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new LogMediatorFigure(new Color(null, 255, 255, 255)) {
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof LogMediatorLogCategoryEditPart) {
            ((LogMediatorLogCategoryEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getFigureLogCatogeryLogPropertyLabel());
            return true;
        }
        if (childEditPart instanceof LogMediatorDescriptionEditPart) {
            ((LogMediatorDescriptionEditPart) childEditPart).setLabel(getPrimaryShape().getLogDescriptionLabel());
            return true;
        }
        if (childEditPart instanceof LogMediatorInputConnectorEditPart) {
            IFigure borderItemFigure = ((LogMediatorInputConnectorEditPart) childEditPart).getFigure();
        ...
        if (childEditPart instanceof LogMediatorOutputConnectorEditPart) {
            IFigure borderItemFigure = ((LogMediatorOutputConnectorEditPart) childEditPart).getFigure();
            BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
    ...
    public class LogMediatorFigure extends EsbGraphicalShapeWithLabel {
        ...
        private void createContents() {
            ...
            fFigureLogCatogeryLogPropertyLabel.setText(DEFAULT_PROPERTY_VALUE_TEXT);
        ...
        public IFigure getToolTip() {
            if (StringUtils.isEmpty(toolTipMessage)) {
                toolTipMessage = Messages.LogMediatorEditPart_ToolTipMessage;
            }
