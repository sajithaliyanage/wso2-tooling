...
import static org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.PROPERTY_MEDIATOR_ICON_PATH;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.PropertyMediatorCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.PropertyMediatorItemSemanticEditPolicy;
...
public class PropertyMediatorEditPart extends FixedSizedAbstractMediator {
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PropertyMediatorItemSemanticEditPolicy());
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new PropertyMediatorFigure(new Color(null, 255, 255, 255)) {
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof PropertyMediatorPropertyNameEditPart) {
            ((PropertyMediatorPropertyNameEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getFigurePropertyMediatorPropertyValueLabel());
            return true;
        }
        if (childEditPart instanceof PropertyMediatorDescriptionEditPart) {
            ((PropertyMediatorDescriptionEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getPropertyMediatorDescriptionLabel());
            return true;
        }
        if (childEditPart instanceof PropertyMediatorInputConnectorEditPart) {
            IFigure borderItemFigure = ((PropertyMediatorInputConnectorEditPart) childEditPart).getFigure();
        ...
        if (childEditPart instanceof PropertyMediatorOutputConnectorEditPart) {
            IFigure borderItemFigure = ((PropertyMediatorOutputConnectorEditPart) childEditPart).getFigure();
            BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
    ...
    public class PropertyMediatorFigure extends EsbGraphicalShapeWithLabel {
         ...
         * @generated
         */
        public PropertyMediatorFigure(Color borderColor) {
        ...
        private void createContents() {
            ...
            fFigurePropertyMediatorPropertyValueLabel.setText(DEFAULT_PROPERTY_VALUE_TEXT);
