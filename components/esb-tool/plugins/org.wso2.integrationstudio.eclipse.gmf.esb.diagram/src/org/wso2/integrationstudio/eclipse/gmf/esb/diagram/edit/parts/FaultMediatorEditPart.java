...
import static org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.FAULT_MEDIATOR_ICON_PATH;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.FaultMediatorCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.FaultMediatorItemSemanticEditPolicy;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.impl.FaultMediatorImpl;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.FaultMediatorTransformer;
...
public class FaultMediatorEditPart extends FixedSizedAbstractMediator {
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new FaultMediatorFigure(new Color(null, 255, 255, 255)) {
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof FaultMediatorFaultStringTypeEditPart) {
            ((FaultMediatorFaultStringTypeEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getFigureFaultMediatorPropertyValue());
            return true;
        }
        if (childEditPart instanceof FaultMediatorDescriptionEditPart) {
            ((FaultMediatorDescriptionEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getFaultMediatorDescriptionLabel());
            return true;
        }
        if (childEditPart instanceof FaultMediatorInputConnectorEditPart) {
            IFigure borderItemFigure = ((FaultMediatorInputConnectorEditPart) childEditPart).getFigure();
        ...
        if (childEditPart instanceof FaultMediatorOutputConnectorEditPart) {
            ...
            IFigure borderItemFigure = ((FaultMediatorOutputConnectorEditPart) childEditPart).getFigure();
            BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
    ...
    public class FaultMediatorFigure extends EsbGraphicalShapeWithLabel {
        ...
        private void createContents() {
            ...
            fFigureFaultMediatorPropertyValue.setText(DEFAULT_PROPERTY_VALUE_TEXT);
        ...
        public String getIconPath() {
            return FAULT_MEDIATOR_ICON_PATH;
        }
        ...
        public IFigure getToolTip() {
            if (StringUtils.isEmpty(toolTipMessage)) {
                toolTipMessage = Messages.FaultMediatorEditPart_ToolTipMessage;
            }
