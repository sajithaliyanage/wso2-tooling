...
import static org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.PAYLOADFACTORY_MEDIATOR_ICON_PATH;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.PayloadFactoryMediatorCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.PayloadFactoryMediatorItemSemanticEditPolicy;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.impl.PayloadFactoryMediatorImpl;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.PayloadFactoryMediatorTransformer;
...
public class PayloadFactoryMediatorEditPart extends FixedSizedAbstractMediator {
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new PayloadFactoryMediatorFigure(new Color(null, 255, 255, 255)) {
    ...
    public void notifyChanged(Notification notification) {
        // this.getModel() will get EMF datamodel of the payload factory mediator
        // datamodel
        if (notification.getEventType() == Notification.SET && this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof PayloadFactoryMediatorImpl) {
                ...
                try {
                    if (payloadFactoryMediatorDataModel.getPayloadFormat() == PayloadFormatType.INLINE) {
                        if (payloadFactoryMediatorDataModel.getPayload() == null
                                || payloadFactoryMediatorDataModel.getPayload().equals("")) {
                            hasError = true;
                        }
                    }
                    if (hasError) {
