...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.MediatorFlowMediatorFlowCompartment11CanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.MediatorFlowMediatorFlowCompartment11ItemSemanticEditPolicy;
...
public class MediatorFlowMediatorFlowCompartment11EditPart extends AbstractMediatorCompartmentEditPart {
    ...
    public void connectNormally(EditPart child) {
        ...
        if ((child instanceof AbstractMediator) || (child instanceof AbstractEndpoint)) {
            ...
            // FIXME
            // This is not a proper fix to get the target output connector. This fix has been made since clone target
            // container and target output connector are in two different models
            CloneMediatorTargetOutputConnectorEditPart relevantTargetOutputConnector = getCloneMediatorTargetOutputConnector(
                    children);
