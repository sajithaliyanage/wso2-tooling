...
import static org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.XQUERY_MEDIATOR_ICON_PATH;

import org.apache.axiom.om.OMElement;
import org.apache.commons.lang.StringUtils;
import org.apache.synapse.SynapseException;
import org.apache.synapse.mediators.xquery.XQueryMediatorSerializer;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.XQueryMediatorCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.XQueryMediatorItemSemanticEditPolicy;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.impl.XQueryMediatorImpl;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.XQueryMediatorTransformer;
...
public class XQueryMediatorEditPart extends FixedSizedAbstractMediator {
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new XQueryMediatorFigure(new Color(null, 255, 255, 255)) {
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof XQueryMediatorScriptKeyTypeEditPart) {
            ((XQueryMediatorScriptKeyTypeEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getFigureXQueryMediatorPropertyValue());
            return true;
        }
        if (childEditPart instanceof XQueryMediatorDescriptionEditPart) {
            ((XQueryMediatorDescriptionEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getXQueryMediatorDescriptionLabel());
            return true;
        }
        if (childEditPart instanceof XQueryMediatorInputConnectorEditPart) {
            IFigure borderItemFigure = ((XQueryMediatorInputConnectorEditPart) childEditPart).getFigure();
        ...
        if (childEditPart instanceof XQueryMediatorOutputConnectorEditPart) {
            IFigure borderItemFigure = ((XQueryMediatorOutputConnectorEditPart) childEditPart).getFigure();
            BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
    ...
    public class XQueryMediatorFigure extends EsbGraphicalShapeWithLabel {
        ...
        private void createContents() {
            ...
            fFigureXQueryMediatorPropertyValue.setText(DEFAULT_PROPERTY_VALUE_TEXT);
        ...
        public String getIconPath() {
            return XQUERY_MEDIATOR_ICON_PATH;
        }
        ...
        public IFigure getToolTip() {
            if (StringUtils.isEmpty(toolTipMessage)) {
                toolTipMessage = Messages.XQueryMediatorEditPart_ToolTipMessage;
            }
