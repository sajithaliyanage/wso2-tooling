...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.custom.connections.ConnectionCalculator;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.custom.layout.XYRepossition;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.custom.utils.MediatorFigureReverser;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.AggregateMediatorEditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.AggregateMediatorInputConnectorEditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.CacheMediatorEditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.CallMediatorEditPart;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.IterateMediatorEditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.IterateMediatorInputConnectorEditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.LoopBackMediatorEditPart;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment12EditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment13EditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment14EditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment15EditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment17EditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment21EditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment22EditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment23EditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment24EditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment25EditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment26EditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment2EditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment3EditPart;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment6EditPart;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.RespondMediatorEditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.RouterMediatorEditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.RuleMediatorEditPart;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.SequenceInputConnectorEditPart;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.ValidateMediatorEditPart;
...
public abstract class AbstractMediator extends AbstractBorderedShapeEditPart implements DroppableElement {
    ...
    public void activate() {
        ...
        if ((i == 1) && (this instanceof SequenceEditPart)) {
            SequenceInputConnectorEditPart seqInputConnectorEditPart = (SequenceInputConnectorEditPart) ((SequenceEditPart) this)
                    .getChildren().get(1);
            SequenceInputConnector seqInputConnector = (SequenceInputConnector) ((org.eclipse.gmf.runtime.notation.impl.NodeImpl) (seqInputConnectorEditPart)
                    .getModel()).getElement();
            SequenceOutputConnectorEditPart seqOutputConnectorEditPart = (SequenceOutputConnectorEditPart) ((SequenceEditPart) this)
                    .getChildren().get(2);
            SequenceOutputConnector seqOutputConnector = (SequenceOutputConnector) ((org.eclipse.gmf.runtime.notation.impl.NodeImpl) (seqOutputConnectorEditPart)
                    .getModel()).getElement();
            if ((seqInputConnector.getIncomingLinks().size() != 0) && (seqInputConnector.getIncomingLinks().get(0)
                    .getSource().eContainer() instanceof AbstractEndPoint)) {
                if ((seqOutputConnector.getOutgoingLink() != null) && (seqOutputConnector.getOutgoingLink().getTarget()
                        .eContainer() instanceof AbstractEndPoint)) {
    ...
    public void notifyChanged(Notification notification) {
        ...
        if (notification.getFeature() instanceof EAttributeImpl) {
            if (notification.getNotifier() instanceof BoundsImpl) {
                if (x != 0 && y != 0) {
                    rePosition(x, y, ((BoundsImpl) notification.getNotifier()).getWidth(),
    ...
    private boolean shouldReverse() {
        for (int i = 0; i < this.getChildren().size(); ++i) {
            if (this.getChildren().get(i) instanceof AbstractMediatorInputConnectorEditPart) {
                AbstractMediatorInputConnectorEditPart inputConnector = (AbstractMediatorInputConnectorEditPart) this
                        .getChildren().get(i);
                if (inputConnector.getTargetConnections().size() != 0) {
                    EditPart link = ((EsbLinkEditPart) inputConnector.getTargetConnections().get(0)).getSource();
                    if ((link instanceof AbstractMediatorOutputConnectorEditPart)
                            && (((AbstractMediatorOutputConnectorEditPart) link)
                                    .getParent() instanceof AbstractMediator)
    ...
    public void reverse(EditPart editorPart) {
        ...
        if (!reversed & (/*
                ...
                | ((editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment3EditPart)
                        && (editorPart.getParent().getParent().getParent() instanceof AggregateMediatorEditPart)
                        && (((AbstractMediator) editorPart.getParent().getParent().getParent()).reversed))
                | (((editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment2EditPart)
                        | (editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment4EditPart))
                        && (editorPart.getParent().getParent().getParent().getParent().getParent()
                                .getParent() instanceof SwitchMediatorEditPart)
                        && (((AbstractMediator) editorPart.getParent().getParent().getParent().getParent().getParent()
                                .getParent()).reversed))
                | (((editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment7EditPart)
                        | (editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment8EditPart))
                        && (editorPart.getParent().getParent().getParent().getParent()
                                .getParent() instanceof FilterMediatorEditPart)
                        && (((AbstractMediator) editorPart.getParent().getParent().getParent().getParent()
                                .getParent()).reversed))
                | ((editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment11EditPart)
                        && (editorPart.getParent().getParent().getParent().getParent()
                                .getParent() instanceof CloneMediatorEditPart)
                        && (((AbstractMediator) editorPart.getParent().getParent().getParent().getParent()
                                .getParent()).reversed))

                | ((editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment15EditPart)
                        && (editorPart.getParent().getParent().getParent().getParent()
                                .getParent() instanceof RouterMediatorEditPart)
                        && (((AbstractMediator) editorPart.getParent().getParent().getParent().getParent()
                                .getParent()).reversed))

                | ((editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment12EditPart)
                        && (editorPart.getParent().getParent().getParent() instanceof IterateMediatorEditPart)
                        && (((AbstractMediator) editorPart.getParent().getParent().getParent()).reversed))
                | (((editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment9EditPart)
                        | (editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment10EditPart))
                        && (editorPart.getParent().getParent().getParent().getParent()
                                .getParent() instanceof ThrottleMediatorEditPart)
                        && (((AbstractMediator) editorPart.getParent().getParent().getParent().getParent()
                                .getParent()).reversed))
                | ((editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment13EditPart)
                        && (editorPart.getParent().getParent().getParent() instanceof CacheMediatorEditPart)
                        && (((AbstractMediator) editorPart.getParent().getParent().getParent()).reversed))

                /*
                 * | ((editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment16EditPart)
                 * && (editorPart.getParent().getParent().getParent() instanceof ConditionalRouterMediatorEditPart) &&
                 * (((AbstractMediator) editorPart
                 * .getParent().getParent().getParent()).reversed))
                 */

                | ((editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment17EditPart)
                        && (editorPart.getParent().getParent().getParent() instanceof RuleMediatorEditPart)
                        && (((AbstractMediator) editorPart.getParent().getParent().getParent()).reversed))

                | (((editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment21EditPart)
                        | (editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment22EditPart)
                        | (editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment23EditPart)
                        | (editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment24EditPart))
                        && (editorPart.getParent().getParent().getParent().getParent()
                                .getParent() instanceof EntitlementMediatorEditPart)
                        && (((AbstractMediator) editorPart.getParent().getParent().getParent().getParent()
                                .getParent()).reversed))

                | ((editorPart.getParent() instanceof MediatorFlowMediatorFlowCompartment14EditPart)
                        && (editorPart.getParent().getParent().getParent() instanceof ValidateMediatorEditPart)
                        && (((AbstractMediator) editorPart.getParent().getParent().getParent()).reversed))
                | (shouldReverse()))) {
    ...
    public void reverseConnectors(EditPart editorPart) {
        ...
        for (int i = 0; i < selectedEP.getChildren().size(); ++i) {
            if (selectedEP.getChildren().get(i) instanceof AbstractMediatorInputConnectorEditPart) {
                ...
                BorderItemLocator inputLocator = new FixedBorderItemLocator(selectedEP.getMainFigure(), inputConnector,
            ...
            if (selectedEP.getChildren().get(i) instanceof AbstractMediatorOutputConnectorEditPart) {
                ...
                EsbLink link = ((OutputConnector) ((Node) ((AbstractMediatorOutputConnectorEditPart) selectedEP
                        .getChildren().get(i)).getModel()).getElement()).getOutgoingLink();
                if (link == null) {
        ...
        if (this instanceof SendMediatorEditPart) {
            ...
            if (!element.isReverse()) {
                ((AbstractMediatorFlowCompartmentEditPart) this.getParent())
                        .removeInSequenceInputConnector((SendMediatorEditPart) this);
    ...
    protected void connectToMostSuitableElement() {
        ...
        AbstractInputConnectorEditPart nearestInputConnector = (AbstractInputConnectorEditPart) ConnectionCalculator
                .getNearestConnectorEditPart(inputConnectorEditpartList, this);
        AbstractOutputConnectorEditPart nearestOutputConnector = (AbstractOutputConnectorEditPart) ConnectionCalculator
                .getNearestConnectorEditPart(outputConnectorEditpartList, this);
        ...
        if (this instanceof SendMediatorEditPart || this instanceof DropMediatorEditPart
                || this instanceof RespondMediatorEditPart || this instanceof LoopBackMediatorEditPart) {
            EditPart compartment = this.getParent();
            // if (isComplexCompartment(compartment) &&
            // restrictAddingOfMediatorInsideComlpexMediators(nearestInputConnector, nearestEsbLinkInputConnector)) {
            // mediatorRestricted = true;
            // if (this instanceof SendMediatorEditPart){
            // mediatorType = "Send Mediator";
            // deleteNewlyAddedMediator(warningAddingMediatorsAlreadyAvailableBegin + mediatorType +
            // warningAddingMediatorsAlreadyAvailableEnd);
            // return;
            // }
        ...
        if (!previouslyConnected) {
            if (nearestESBLink != null) {
                ...
                if ((!(nearestEsbLinkOutputConnector instanceof ProxyOutputConnectorEditPart))
                        ...
                        && (!nearestEsbLinkOutputConnector.getParent().getParent().equals(this.getParent()))
                        && (!EditorUtils.getMediator(nearestEsbLinkOutputConnector)
                                .equals(EditorUtils.getMediator(this.getParent())))) {
                    nearestESBLink = null;
                    connectNormally();
                }
            } else {
            ...
            if (nearestESBLink != null) {
                ...
                col.add(((org.eclipse.gmf.runtime.notation.impl.ConnectorImpl) nearestESBLink.getModel()).getElement());
            ...
            if (nearestESBLink != null) {
                DeleteCommand delCmd = new DeleteCommand(nearestESBLink.getNotationView());
    ...
    private void fillConnectorsLists(ArrayList<EsbLinkEditPart> esbLinkEditpartList,
        ...
        for (int i = 0; i < getViewer().getEditPartRegistry().size(); ++i) {
            ...
            EditPart element = (EditPart) getViewer().getEditPartRegistry().values().toArray()[i];
            ...
            if (element instanceof EsbLinkEditPart) {
                 ...
                 * 
                 * if(!(EditorUtils.getMediator(((EsbLinkEditPart)element).getSource())).equals(EditorUtils.getMediator(
                 * this.getParent()))
                ...
                if (((AbstractOutputConnectorEditPart) element).getParent().getParent().equals(this.getParent())) {
                    outputConnectorEditpartList.add((AbstractOutputConnectorEditPart) element);
                        ...
                        .equals(this.getParent().getParent().getParent().getParent().getParent())) {
                    /*
                    ...
                    outputConnectorEditpartList.add((AbstractOutputConnectorEditPart) element);
                        ...
                        .equals(this.getParent().getParent().getParent())) {
                    /*
                    ...
                    outputConnectorEditpartList.add((AbstractOutputConnectorEditPart) element);
                        ...
                        .equals(this.getParent().getParent().getParent().getParent().getParent().getParent())) {
                    /*
                ...
                if (((AbstractInputConnectorEditPart) element).getParent().getParent().equals(this.getParent())) {
                    inputConnectorEditpartList.add((AbstractInputConnectorEditPart) element);
                } else if (((AbstractInputConnectorEditPart) element).getParent()
                        .equals(this.getParent().getParent().getParent().getParent().getParent())) {
                    /*
                     * for proxy service input Connector
                     */
                    if (((this.getParent() instanceof MediatorFlowMediatorFlowCompartment6EditPart)
                            && ((AbstractInputConnectorEditPart) element instanceof ProxyFaultInputConnectorEditPart))
                            || ((this.getParent() instanceof MediatorFlowMediatorFlowCompartmentEditPart)
                                    && ((AbstractInputConnectorEditPart) element instanceof ProxyInputConnectorEditPart))
                            || ((this.getParent() instanceof MediatorFlowMediatorFlowCompartmentEditPart)
                                    && ((AbstractInputConnectorEditPart) element instanceof APIResourceInputConnectorEditPart))) {
                        inputConnectorEditpartList.add((AbstractInputConnectorEditPart) element);
                    }
                } else if (((AbstractInputConnectorEditPart) element).getParent()
                        .equals(this.getParent().getParent().getParent())) {
    ...
    private void updateCurrentStates(AbstractMediatorOutputConnectorEditPart currentOutputConnector) {
        if (this.getParent() instanceof MediatorFlowMediatorFlowCompartmentEditPart) {
            ((MediatorFlowMediatorFlowCompartmentEditPart) this.getParent())
                    .setOutputConnectorEditPart(currentOutputConnector);
            ((MediatorFlowMediatorFlowCompartmentEditPart) this.getParent()).setSourceEditPart(this);
        } else if (this.getParent() instanceof MediatorFlowMediatorFlowCompartment5EditPart) {
            ((MediatorFlowMediatorFlowCompartment5EditPart) this.getParent())
                    .setOutputConnectorEditPart(currentOutputConnector);
    ...
    private boolean checkComplexity() {
        if ((this instanceof AggregateMediatorEditPart) || (this instanceof SwitchMediatorEditPart)
                || (this instanceof FilterMediatorEditPart) || (this instanceof SendMediatorEditPart)
                || (this instanceof CallMediatorEditPart) || (this instanceof ThrottleMediatorEditPart)
                || (this instanceof CacheMediatorEditPart) || (this instanceof CloneMediatorEditPart)
                || (this instanceof IterateMediatorEditPart) || (this instanceof ValidateMediatorEditPart)
                || (this instanceof RouterMediatorEditPart)
                // || (this instanceof ConditionalRouterMediatorEditPart)
                || (this instanceof EntitlementMediatorEditPart) || (this instanceof RuleMediatorEditPart)) {
            return true;
        } else {
            return false;
        }
    ...
    private AbstractMediator getSecondLastMediatorBybackTraverse(
            AbstractEndpointOutputConnectorEditPart outputConnector) {
        ...
        List<AbstractGraphicalEditPart> conectedEdbLinkstoInputConnector = endpointInputConnector
                .getTargetConnections();
        if (conectedEdbLinkstoInputConnector != null && conectedEdbLinkstoInputConnector.size() > 0) {

            EsbLinkEditPart linkFromSend = (EsbLinkEditPart) conectedEdbLinkstoInputConnector.get(0); // wrong
                                                                                                      // assumption,
                                                                                                      // what if more
                                                                                                      // than one
    ...
    private Sequence getSequenceMediatorFrom(AbstractOutputConnectorEditPart outputConnector) {
        ...
        EditPart node = (ShapeNodeEditPart) ((EsbLinkEditPart) outputConnector.getSourceConnections().get(0))
                .getTarget().getParent();
    ...
    private void deleteNewlyAddedMediator(String reason) {
        ...
        RemoveCommand removeCmd = new RemoveCommand(this.getEditingDomain(),
                ((Node) this.getModel()).getElement().eContainer(), EsbPackage.Literals.MEDIATOR_FLOW__CHILDREN,
    ...
    private boolean restrictAddingOfMediatorInsideComlpexMediators(AbstractInputConnectorEditPart nearestInputConnector,
    ...
    private boolean restrictAddingOfMediator(AbstractInputConnectorEditPart nearestInputConnector,
            AbstractConnectorEditPart nearestEsbLinkInputConnector) {
        boolean restricted = false;
    ...
    private boolean hasNextMediator(EditPart complexMediator) {
        ...
        AbstractMediatorOutputConnectorEditPart complexMediatorOutputConnector = (AbstractMediatorOutputConnectorEditPart) EditorUtils
                .getMediatorOutputConnector((ShapeNodeEditPart) complexMediator);
    ...
    private AbstractMediator hasMediator(AbstractMediator mediator) {
        ...
        if (mediator instanceof SendMediatorEditPart || mediator instanceof RespondMediatorEditPart
                || mediator instanceof LoopBackMediatorEditPart) {
            ...
            ShapeNodeEditPart childContainer = EditorUtils
                    .getChildContainer((MultipleCompartmentComplexFiguredAbstractMediator) mediator);
            List<EditPart> childEditParts = new ArrayList<EditPart>();

            if (childContainer instanceof SwitchMediatorContainerEditPart) {
                List<EditPart> caseEditParts = ((SwitchCaseParentContainerEditPart) childContainer.getChildren().get(0))
                        .getChildren();
                List<EditPart> defaultEditParts = ((SwitchDefaultParentContainerEditPart) childContainer.getChildren()
                        .get(1)).getChildren();
            ...
            for (EditPart editPart : childEditParts) {
                ...
                if (mediatorFlowCompartment.getChildren().size() >= 1) {
                    for (int i = 0; i < mediatorFlowCompartment.getChildren().size(); ++i) {
                        ...
                        // TO DO - Handle for Drop Mediator
                        if (gep instanceof SendMediatorEditPart || gep instanceof RespondMediatorEditPart
                                || gep instanceof LoopBackMediatorEditPart) {
    ...
    private boolean isValidMediatorAddition(AbstractConnectorEditPart nearestEsbLinkOutputConnector,
            AbstractConnectorEditPart nearestEsbLinkInputConnector) {

        boolean isValid = true;
        if (nearestEsbLinkOutputConnector instanceof SendMediatorOutputConnectorEditPart
                && nearestEsbLinkInputConnector instanceof AbstractEndpointInputConnectorEditPart) {
            return false;
        }

        if (nearestEsbLinkOutputConnector instanceof AbstractEndpointOutputConnectorEditPart
                && nearestEsbLinkInputConnector instanceof SequenceInputConnectorEditPart) {
            Sequence seq = getSequenceMediatorFrom(
                    (AbstractEndpointOutputConnectorEditPart) nearestEsbLinkOutputConnector);
            if (seq.isDuplicate()) {
                return false;
            }
        }

        if (nearestEsbLinkOutputConnector instanceof SequenceOutputConnectorEditPart
                && nearestEsbLinkInputConnector instanceof AbstractEndpointInputConnectorEditPart) {
            Sequence seq = getSequenceMediatorByBackTraverse(
                    (SequenceOutputConnectorEditPart) nearestEsbLinkOutputConnector);
            if (seq.isDuplicate()) {
                return false;
            }
        }
