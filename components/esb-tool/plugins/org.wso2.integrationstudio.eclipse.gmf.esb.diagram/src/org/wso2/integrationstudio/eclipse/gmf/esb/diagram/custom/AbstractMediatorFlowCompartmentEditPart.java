...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.CloudConnectorOperationEditPart;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.CloudConnectorOperationEditPart.CloudConnectorOperationFigure;
...
public class AbstractMediatorFlowCompartmentEditPart extends ShapeCompartmentEditPart {
    ...
    public void addInSequenceInputConnector(SendMediatorEditPart sendMediatorEditPart) {
        ...
        if (abstractBaseFigureEditPart != null) {
            ...
            AddCommand addCommand = new AddCommand(getEditingDomain(),
                    ((Node) abstractBaseFigureEditPart.getModel()).getElement(), eStructuralFeature, inputConnector);
            if (addCommand.canExecute()) {
                getEditingDomain().getCommandStack().execute(addCommand);
            }
            abstractBaseFigureEditPart.getSendMediatorAndInSequenceInputConnectorMap().put(inputConnector,
                    sendMediatorEditPart);
        }
    }
    ...
    public void removeInSequenceInputConnector(SendMediatorEditPart sendMediatorEditPart) {
        ...
        AbstractBaseFigureEditPart abstractBaseFigureEditPart = EditorUtils.getAbstractBaseFigureEditPart(this);
        if (abstractBaseFigureEditPart != null) {
            Map<InputConnector, SendMediatorEditPart> map = EditorUtils.getAbstractBaseFigureEditPart(this)
            ...
            RemoveCommand removeCmd = new RemoveCommand(getEditingDomain(),
                    ((Node) abstractBaseFigureEditPart.getModel()).getElement(), eStructuralFeature,
    ...
    protected void addChild(EditPart child, int index) {
        ...
        if (child instanceof SendMediatorEditPart) {
            if (((SendMediator) ((Node) ((SendMediatorEditPart) child).getModel()).getElement()).getOutputConnector()
                    .getOutgoingLink() == null
                    && !((SendMediator) ((Node) ((SendMediatorEditPart) child).getModel()).getElement()).isReverse()) {
        ...
        if (child instanceof SequenceEditPart) {
            ...
            EditPart editpart = (EditPart) ((StructuredSelection) sequenceEditPart.getViewer().getEditDomain()
            ...
            if (editpart instanceof ToolEntryEditPart) {
                if (((ToolEntryEditPart) editpart).getModel() instanceof NodeToolEntry) {
                    ...
                    try {
                        ((Sequence) ((View) sequenceEditPart.getModel()).getElement()).setName(sequenceName);
                    } catch (java.lang.IllegalStateException e) {
                        log.error("This is occured while undo operation..", e);
                    }
                } else if (((ToolEntryEditPart) editpart)
                        .getModel() instanceof org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.SequenceEditPart.NodeToolEntry) {
                    String label = ((org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.SequenceEditPart.NodeToolEntry) ((ToolEntryEditPart) editpart)
                            .getModel()).getLabel();
                    if ((!label.equals("")) && (!label.equals("Sequence Mediator"))) {
                        sequenceName = label;
                    } else {
            ...
            EObject sequence = ((org.eclipse.gmf.runtime.notation.impl.NodeImpl) (sequenceEditPart).getModel())
                    .getElement();
        ...
        if (child instanceof CloudConnectorOperationEditPart) {
            ...
            EditPart editpart = (EditPart) ((StructuredSelection) cloudConnectorOperationEditPart.getViewer()
            ...
            if (editorpart != null && !EditorUtils.isLockmode(((EsbMultiPageEditor) editorpart).getGraphicalEditor())) {
                if (editpart instanceof ToolEntryEditPart) {
                    if (((ToolEntryEditPart) editpart).getModel() instanceof NodeToolEntry) {
                        String id = ((NodeToolEntry) ((ToolEntryEditPart) editpart).getModel()).getId();
                        try {
                            ...
                            ((CloudConnectorOperation) ((View) cloudConnectorOperationEditPart.getModel()).getElement())
                                    .setConnectorName(getCloudConnectorDirectoryTraverser(groupName.toLowerCase())
                                            .getCloudConnectorName());

                            ((CloudConnectorOperation) ((View) cloudConnectorOperationEditPart.getModel()).getElement())
                                    .setCloudConnectorName(groupName.toLowerCase());

                            ((CloudConnectorOperation) ((View) cloudConnectorOperationEditPart.getModel()).getElement())
                                    .setOperationName(
                                            ((NodeToolEntry) ((ToolEntryEditPart) editpart).getModel()).getLabel());
    ...
    private void connectRemainingElements(EditPart child) {
        if (child instanceof AbstractMediator) {
            ConnectionUtils.createConnection(((AbstractMediator) child).getConnectedInputConnector(),
                    ((AbstractMediator) child).getConnectedOutputConnector());
        }
    }
}
