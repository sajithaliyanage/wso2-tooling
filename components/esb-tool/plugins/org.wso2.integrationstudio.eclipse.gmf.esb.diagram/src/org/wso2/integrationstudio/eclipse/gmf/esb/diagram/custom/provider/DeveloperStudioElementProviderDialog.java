...
public class DeveloperStudioElementProviderDialog extends Dialog {
    ...
    private static IDeveloperStudioLog log = Logger.getLog("org.wso2.integrationstudio.eclipse.esb.editor");
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        treeViewer.setContentProvider(new ITreeContentProvider() {
            ...
            private Object[] createTreeItemList(Object o) {
                ...
                } else if (o instanceof IDeveloperStudioProvider || o instanceof IDeveloperStudioProviderData) {
                    IDeveloperStudioProvider provider = o instanceof IDeveloperStudioProvider
            ...
            private boolean isChildElementsPresent(IDeveloperStudioProvider provider) {
                IDeveloperStudioElement[] resources = provider.getElements(getFilters());
                IDeveloperStudioProvider[] categories = provider.getCategories(getFilters());
                return (resources != null && resources.length > 0) || (categories != null && categories.length > 0);
            }
    ...
    protected void openNewResourceTemplateDialog() {
        ...
        try {
            NewResourceTemplateDialog newResourceTemplateDialog = new NewResourceTemplateDialog(getParentShell(),
