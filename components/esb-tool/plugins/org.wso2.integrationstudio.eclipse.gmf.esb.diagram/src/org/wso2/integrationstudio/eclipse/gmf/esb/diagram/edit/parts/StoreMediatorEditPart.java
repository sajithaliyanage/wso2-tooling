...
import static org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.STORE_MEDIATOR_ICON_PATH;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.StoreMediatorCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.StoreMediatorItemSemanticEditPolicy;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.impl.StoreMediatorImpl;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.StoreMediatorTransformer;
...
public class StoreMediatorEditPart extends FixedSizedAbstractMediator {
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new StoreMediatorFigure(new Color(null, 255, 255, 255)) {
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        ...
        if (childEditPart instanceof StoreMediatorDescriptionEditPart) {
            ((StoreMediatorDescriptionEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getStoreMediatorDescriptionLabel());
            return true;
        }
        if (childEditPart instanceof StoreMediatorInputConnectorEditPart) {
            IFigure borderItemFigure = ((StoreMediatorInputConnectorEditPart) childEditPart).getFigure();
        ...
        if (childEditPart instanceof StoreMediatorOutputConnectorEditPart) {
            IFigure borderItemFigure = ((StoreMediatorOutputConnectorEditPart) childEditPart).getFigure();
            BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
    ...
    protected boolean removeFixedChild(EditPart childEditPart) {
        ...
        if (childEditPart instanceof StoreMediatorInputConnectorEditPart) {
            getBorderedFigure().getBorderItemContainer()
                    .remove(((StoreMediatorInputConnectorEditPart) childEditPart).getFigure());
            return true;
        }
        if (childEditPart instanceof StoreMediatorOutputConnectorEditPart) {
            getBorderedFigure().getBorderItemContainer()
                    .remove(((StoreMediatorOutputConnectorEditPart) childEditPart).getFigure());
            return true;
        }
        return false;
    }
    ...
    public class StoreMediatorFigure extends EsbGraphicalShapeWithLabel {
        ...
        private void createContents() {
            ...
            fFigureStoreMediatorPropertyValue.setText(DEFAULT_PROPERTY_VALUE_TEXT);
        ...
        public IFigure getToolTip() {
            if (StringUtils.isEmpty(toolTipMessage)) {
                toolTipMessage = Messages.StoreMediatorEditPart_ToolTipMessage;
            }
