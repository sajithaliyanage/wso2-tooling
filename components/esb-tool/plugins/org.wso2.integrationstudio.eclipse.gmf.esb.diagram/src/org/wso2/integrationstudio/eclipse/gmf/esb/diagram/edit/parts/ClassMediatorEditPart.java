...
import static org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.EditPartConstants.CLASS_MEDIATOR_ICON_PATH;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.ClassMediatorCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.ClassMediatorItemSemanticEditPolicy;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.impl.ClassMediatorImpl;
...
public class ClassMediatorEditPart extends FixedSizedAbstractMediator {
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof ClassMediatorClassNameEditPart) {
            ((ClassMediatorClassNameEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getFigureClassMediatorPropertyValue());
            return true;
        }
        if (childEditPart instanceof ClassMediatorDescriptionEditPart) {
            ((ClassMediatorDescriptionEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getClassMediatorDescriptionLabel());
            return true;
        }
        if (childEditPart instanceof ClassMediatorInputConnectorEditPart) {
            IFigure borderItemFigure = ((ClassMediatorInputConnectorEditPart) childEditPart).getFigure();
        ...
        if (childEditPart instanceof ClassMediatorOutputConnectorEditPart) {
            IFigure borderItemFigure = ((ClassMediatorOutputConnectorEditPart) childEditPart).getFigure();
            BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
    ...
    public class ClassMediatorFigure extends EsbGraphicalShapeWithLabel {
        ...
        private void createContents() {
            ...
            fFigureClassMediatorPropertyValue.setText(DEFAULT_PROPERTY_VALUE_TEXT);
        ...
        public String getIconPath() {
            return CLASS_MEDIATOR_ICON_PATH;
        }

        public String getNodeName() {
            return Messages.ClassMediatorEditPart_NodeName;
        }

        public IFigure getToolTip() {
            if (StringUtils.isEmpty(toolTipMessage)) {
                toolTipMessage = Messages.ClassMediatorEditPart_ToolTipMessage;
            }
