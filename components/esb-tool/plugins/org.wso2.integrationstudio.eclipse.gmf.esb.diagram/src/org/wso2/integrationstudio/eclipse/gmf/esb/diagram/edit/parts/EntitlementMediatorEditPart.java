...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.EntitlementMediatorCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.EntitlementMediatorItemSemanticEditPolicy;
...
public class EntitlementMediatorEditPart extends MultipleCompartmentComplexFiguredAbstractMediator {
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof EntitlementMediatorServerURLEditPart) {
            ((EntitlementMediatorServerURLEditPart) childEditPart)
                    .setLabel(getPrimaryShape().getFigureEntitlementMediatorPropertyValue());
            return true;
        }
        /*
    ...
    public class EntitlementMediatorFigure extends EntitlementMediatorGraphicalShape {
        ...
        private void createContents() {
            ...
            fFigureEntitlementMediatorPropertyValue.setText(DEFAULT_PROPERTY_VALUE_TEXT);
        ...
        public IFigure getToolTip() {
            if (StringUtils.isEmpty(toolTipMessage)) {
                toolTipMessage = Messages.EntitlementMediatorEditPart_ToolTipMessage;
            }
     ...
     * @generated NOT
     */
    static final Color THIS_BACK = new Color(null, 52, 73, 94);
