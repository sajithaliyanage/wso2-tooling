...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.MediatorFlowMediatorFlowCompartmentCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.MediatorFlowMediatorFlowCompartmentItemSemanticEditPolicy;
...
public class MediatorFlowMediatorFlowCompartmentEditPart extends AbstractMediatorFlowCompartmentEditPart {
    ...
    protected void addChildVisual(EditPart childEditPart, int index) {
        ...
        if (childEditPart instanceof AbstractEndpoint) {
            borderedNodeFigure.getBorderItemContainer().add(((AbstractEndpoint) childEditPart).getFigure(),
                    new SlidingBorderItemLocator(borderedNodeFigure.getMainFigure(),
                            ((AbstractEndpoint) childEditPart).getFigure(), PositionConstants.EAST, 10, 5));
        }
    ...
    protected void addChild(EditPart child, int index) {
        ...
        ((MediatorFlowEditPart) child.getParent().getParent())
                .refreshConnector(child.getParent().getParent().getParent().getParent().getParent());
         ...
         * org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.SequenceEditPart.NodeToolEntry) {
         * String label = ((org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.SequenceEditPart.NodeToolEntry)
        ...
        if (child instanceof FailoverEndPointEditPart) {
            ...
            if (editpart instanceof ToolEntryEditPart) {
                if (((ToolEntryEditPart) editpart).getModel() instanceof NodeToolEntry) {
                   ...
                   * else if (((ToolEntryEditPart) editpart).getModel() instanceof
                   * org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.
                   * SequenceEditPart.NodeToolEntry) { String label =
                   * ((org.wso2.integrationstudio
        ...
        if ((child instanceof AbstractMediator) || (child instanceof AbstractEndpoint)) {
            ...
            if (inputConnector != null) {
                ICommand createSubTopicsCmd = new DeferredCreateConnectionViewAndElementCommand(
                        ...
                        new EObjectAdapter((EObject) outputConnectorEditPart.getModel()),
                        new EObjectAdapter((EObject) (inputConnector).getModel()), sourceEditPart.getViewer());
