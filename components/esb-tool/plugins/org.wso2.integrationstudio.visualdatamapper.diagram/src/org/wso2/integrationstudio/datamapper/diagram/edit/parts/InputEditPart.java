...
import org.wso2.integrationstudio.datamapper.diagram.custom.util.DialogDisplayUtils;
import org.wso2.integrationstudio.datamapper.diagram.custom.util.ImageHolder;
import org.wso2.integrationstudio.datamapper.diagram.custom.util.SchemaKeyEditorDialog;
...
import org.wso2.integrationstudio.datamapper.diagram.edit.policies.InputCanonicalEditPolicy;
import org.wso2.integrationstudio.datamapper.diagram.edit.policies.InputItemSemanticEditPolicy;
import org.wso2.integrationstudio.datamapper.diagram.tree.generator.ISchemaTransformer;
...
public class InputEditPart extends ShapeNodeEditPart {
	...
	private void convertTree(Tree tree, TreeNode treeNode) {
		...
		if (!(tree.getElements().isEmpty())) {
			for (org.wso2.integrationstudio.datamapper.diagram.tree.model.Element element : tree.getElements()) {
	 ...
	 * @generated NOT
	 */
	private void createElement(org.wso2.integrationstudio.datamapper.diagram.tree.model.Element element,
			TreeNode treeNode) {
	...
	private void createTree(Tree treeN, TreeNode treeNode) {
		...
		if (!(treeN.getElements().isEmpty())) {
			for (org.wso2.integrationstudio.datamapper.diagram.tree.model.Element element : treeN.getElements()) {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.wso2.integrationstudio.datamapper.diagram.edit.policies.InputItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new org.wso2.integrationstudio.datamapper.diagram.edit.policies.InputCanonicalEditPolicy());
