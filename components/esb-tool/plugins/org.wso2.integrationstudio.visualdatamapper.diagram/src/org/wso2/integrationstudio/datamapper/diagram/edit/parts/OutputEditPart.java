...
import org.wso2.integrationstudio.datamapper.diagram.edit.policies.OutputCanonicalEditPolicy;
import org.wso2.integrationstudio.datamapper.diagram.edit.policies.OutputItemSemanticEditPolicy;
...
public class OutputEditPart extends ShapeNodeEditPart {
	...
	private void convertTree(Tree tree, TreeNode treeNode) {
		 ...
		 * (org.wso2.integrationstudio.datamapper.diagram.tree.model.Attribute
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.wso2.integrationstudio.datamapper.diagram.edit.policies.OutputItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new org.wso2.integrationstudio.datamapper.diagram.edit.policies.OutputCanonicalEditPolicy());
