	...
	private static class OpenDiagramAction extends Action {
		...
		public void run() {
			/*			if (myDiagram == null || myDiagram.eResource() == null) {
			 ...
			 org.wso2.integrationstudio.datamapper.diagram.part.DataMapperDiagramEditor.ID);
			 } catch (PartInitException e) {
			 org.wso2.integrationstudio.datamapper.diagram.part.DataMapperDiagramEditorPlugin
