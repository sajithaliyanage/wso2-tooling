...
public class MessageProcessorImpl extends EsbElementImpl implements MessageProcessor {
    ...
    protected MessageProcessorImpl() {
        ...
        DeveloperStudioProviderUtils.addFilter((Map<String, List<String>>) replaySequence.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, ESBMediaTypeConstants.MEDIA_TYPE_SEQUENCE);
        ...
        DeveloperStudioProviderUtils.addFilter((Map<String, List<String>>) faultSequence.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, ESBMediaTypeConstants.MEDIA_TYPE_SEQUENCE);
    ...
    public void setMaxStoreConnectionAttempts(int newMaxStoreConnectionAttempts) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.MESSAGE_PROCESSOR__MAX_STORE_CONNECTION_ATTEMPTS, oldMaxStoreConnectionAttempts,
                    maxStoreConnectionAttempts));
    }
    ...
    public void setStoreConnectionInterval(int newStoreConnectionInterval) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.MESSAGE_PROCESSOR__STORE_CONNECTION_INTERVAL, oldStoreConnectionInterval,
                    storeConnectionInterval));
    }
    ...
    public void setFailMessagesStore(String newFailMessagesStore) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.MESSAGE_PROCESSOR__FAIL_MESSAGES_STORE,
                    oldFailMessagesStore, failMessagesStore));
    }
