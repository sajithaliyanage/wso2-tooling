...
public class DataMapperMediatorImpl extends MediatorImpl implements DataMapperMediator {
    ...
    /**
	 * The cached value of the '{@link #getXsltStyleSheet() <em>Xslt Style Sheet</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected RegistryKeyProperty xsltStyleSheet;
    ...
    /**
	 * The default value of the '{@link #getXsltStyleSheetLocalPath() <em>Xslt Style Sheet Local Path</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getXsltStyleSheetLocalPath()
	 * @generated
	 * @ordered
	 */
	protected static final String XSLT_STYLE_SHEET_LOCAL_PATH_EDEFAULT = null;

				/**
	 * The cached value of the '{@link #getXsltStyleSheetLocalPath() <em>Xslt Style Sheet Local Path</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getXsltStyleSheetLocalPath()
	 * @generated
	 * @ordered
	 */
	protected String xsltStyleSheetLocalPath = XSLT_STYLE_SHEET_LOCAL_PATH_EDEFAULT;
	 ...
	 * @generated
	 */
	public RegistryKeyProperty getXsltStyleSheet() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetXsltStyleSheet(RegistryKeyProperty newXsltStyleSheet, NotificationChain msgs) {
		RegistryKeyProperty oldXsltStyleSheet = xsltStyleSheet;
		xsltStyleSheet = newXsltStyleSheet;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET, oldXsltStyleSheet, newXsltStyleSheet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setXsltStyleSheet(RegistryKeyProperty newXsltStyleSheet) {
		if (newXsltStyleSheet != xsltStyleSheet) {
			NotificationChain msgs = null;
			if (xsltStyleSheet != null)
				msgs = ((InternalEObject)xsltStyleSheet).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET, null, msgs);
			if (newXsltStyleSheet != null)
				msgs = ((InternalEObject)newXsltStyleSheet).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET, null, msgs);
			msgs = basicSetXsltStyleSheet(newXsltStyleSheet, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET, newXsltStyleSheet, newXsltStyleSheet));
	}
	 ...
	 * @generated
	 */
	public String getXsltStyleSheetLocalPath() {
		return xsltStyleSheetLocalPath;
	}
	 ...
	 * @generated
	 */
	public void setXsltStyleSheetLocalPath(String newXsltStyleSheetLocalPath) {
		String oldXsltStyleSheetLocalPath = xsltStyleSheetLocalPath;
		xsltStyleSheetLocalPath = newXsltStyleSheetLocalPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET_LOCAL_PATH, oldXsltStyleSheetLocalPath, xsltStyleSheetLocalPath));
	}
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET:
				return basicSetXsltStyleSheet(null, msgs);
		}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET_LOCAL_PATH:
				return getXsltStyleSheetLocalPath();
    ...
    public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EsbPackage.DATA_MAPPER_MEDIATOR__OUTPUT_SCHEMA:
				...
				return;
			case EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET:
				setXsltStyleSheet((RegistryKeyProperty)newValue);
				return;
			case EsbPackage.DATA_MAPPER_MEDIATOR__CONFIGURATION_LOCAL_PATH:
			...
			case EsbPackage.DATA_MAPPER_MEDIATOR__OUTPUT_SCHEMA_LOCAL_PATH:
				...
				return;
			case EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET_LOCAL_PATH:
				setXsltStyleSheetLocalPath((String)newValue);
				return;
			case EsbPackage.DATA_MAPPER_MEDIATOR__OUTPUT_TYPE:
    ...
    public void eUnset(int featureID) {
		switch (featureID) {
			...
			case EsbPackage.DATA_MAPPER_MEDIATOR__OUTPUT_SCHEMA:
				...
				return;
			case EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET:
				setXsltStyleSheet((RegistryKeyProperty)null);
				return;
			case EsbPackage.DATA_MAPPER_MEDIATOR__CONFIGURATION_LOCAL_PATH:
			...
			case EsbPackage.DATA_MAPPER_MEDIATOR__OUTPUT_SCHEMA_LOCAL_PATH:
				...
				return;
			case EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET_LOCAL_PATH:
				setXsltStyleSheetLocalPath(XSLT_STYLE_SHEET_LOCAL_PATH_EDEFAULT);
				return;
			case EsbPackage.DATA_MAPPER_MEDIATOR__OUTPUT_TYPE:
    ...
    public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET_LOCAL_PATH:
				return XSLT_STYLE_SHEET_LOCAL_PATH_EDEFAULT == null ? xsltStyleSheetLocalPath != null : !XSLT_STYLE_SHEET_LOCAL_PATH_EDEFAULT.equals(xsltStyleSheetLocalPath);
			case EsbPackage.DATA_MAPPER_MEDIATOR__OUTPUT_TYPE:
    ...
    public String toString() {
		...
		result.append(outputSchemaLocalPath);
		result.append(", xsltStyleSheetLocalPath: ");
		result.append(xsltStyleSheetLocalPath);
