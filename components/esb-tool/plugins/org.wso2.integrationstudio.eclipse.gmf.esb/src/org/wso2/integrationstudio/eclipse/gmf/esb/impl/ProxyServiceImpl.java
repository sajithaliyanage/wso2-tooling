...
public class ProxyServiceImpl extends EsbElementImpl implements ProxyService {
    ...
    protected ProxyServiceImpl() {
        ...
        DeveloperStudioProviderUtils.addFilter((Map<String, List<String>>) wsdlKey.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, PlatformMediaTypeConstants.MEDIA_TYPE_WSDL);
        ...
        DeveloperStudioProviderUtils.addFilter((Map<String, List<String>>) wsdlEndpointKey.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, PlatformMediaTypeConstants.MEDIA_TYPE_WSDL);
        ...
        DeveloperStudioProviderUtils.addFilter((Map<String, List<String>>) inSequenceOnErroKey.getFilters(),
        ...
        DeveloperStudioProviderUtils.addFilter((Map<String, List<String>>) outSequenceOnErroKey.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, ESBMediaTypeConstants.MEDIA_TYPE_SEQUENCE);
        ...
        DeveloperStudioProviderUtils.addFilter((Map<String, List<String>>) faultSequenceOnErroKey.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, ESBMediaTypeConstants.MEDIA_TYPE_SEQUENCE);
     ...
     * @generated
     */
    public NotificationChain basicSetFaultInputConnector(ProxyFaultInputConnector newFaultInputConnector,
    ...
    public NotificationChain basicSetOutSequenceOutputConnector(
            ProxyOutSequenceOutputConnector newOutSequenceOutputConnector, NotificationChain msgs) {
    ...
    public void setTraceEnabled(boolean newTraceEnabled) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__TRACE_ENABLED,
     ...
     * @generated
     */
    public NotificationChain basicSetInSequenceOnError(RegistryKeyProperty newInSequenceOnError,
            NotificationChain msgs) {
     ...
     * @generated
     */
    public NotificationChain basicSetOutSequenceOnError(RegistryKeyProperty newOutSequenceOnError,
            NotificationChain msgs) {
     ...
     * @generated
     */
    public NotificationChain basicSetFaultSequenceOnError(RegistryKeyProperty newFaultSequenceOnError,
            NotificationChain msgs) {
