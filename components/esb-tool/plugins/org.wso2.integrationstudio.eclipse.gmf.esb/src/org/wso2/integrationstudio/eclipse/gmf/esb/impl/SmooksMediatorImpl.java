...
public class SmooksMediatorImpl extends MediatorImpl implements SmooksMediator {
    ...
    protected SmooksMediatorImpl() {
        ...
        DeveloperStudioProviderUtils.addFilter((Map<String, java.util.List<String>>) configurationKey.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, PlatformMediaTypeConstants.MEDIA_TYPE_SMOOKS);
