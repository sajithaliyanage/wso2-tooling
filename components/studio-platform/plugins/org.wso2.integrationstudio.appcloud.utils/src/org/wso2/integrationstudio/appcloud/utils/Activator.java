...
package org.wso2.integrationstudio.appcloud.utils;
...
public class Activator implements BundleActivator {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.wso2.integrationstudio.appcloud.utils"; //$NON-NLS-1$
	...
	private static boolean loadJKSfromEclipsePrefernaces() {
		 ...
		 * TRUST_STORE_LOCATION).isEmpty()){ return false; }
		 * if(preferenceStore.getString(ClientTrustStorePreferencePage.
		 * TRUST_STORE_PASSWORD).isEmpty()){ return false; }
		 * if(preferenceStore.getString(ClientTrustStorePreferencePage.
		 * TRUST_STORE_TYPE).isEmpty()){ return false; }
		 * 
		 * System.setProperty("javax.net.ssl.trustStore",
		 * preferenceStore.getString(ClientTrustStorePreferencePage.
		 ...
		 * 
		 * }catch(Exception e){ IDeveloperStudioLog log =
