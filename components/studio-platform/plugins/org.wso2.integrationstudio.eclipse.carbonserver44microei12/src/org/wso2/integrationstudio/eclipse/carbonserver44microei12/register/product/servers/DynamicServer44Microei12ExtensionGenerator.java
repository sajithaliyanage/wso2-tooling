...
public class DynamicServer44Microei12ExtensionGenerator {
    private static IDeveloperStudioLog log = Logger.getLog(Activator.PLUGIN_ID);

    private static final String MASTER_TOKEN = "masterToken";
    private static final String SERVER_MI_STREAM_LOCATION = "resources/streams/server44microei12.xml";
    private static final String SERVER_VERSION_CARBON = "carbon.server.44microei12";
