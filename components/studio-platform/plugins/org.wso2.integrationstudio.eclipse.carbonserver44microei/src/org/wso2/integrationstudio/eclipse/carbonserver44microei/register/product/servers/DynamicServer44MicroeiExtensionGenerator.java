...
public class DynamicServer44MicroeiExtensionGenerator {
	private static final String MASTER_TOKEN = "masterToken";
	private static final String SERVER_44ei_STREAM_LOC = "resources/streams/server44microei.xml";
	private static IDeveloperStudioLog log = Logger.getLog(Activator.PLUGIN_ID);
	private static final String SERVER_VERSION_CARBON = "carbon.server.44microei";
