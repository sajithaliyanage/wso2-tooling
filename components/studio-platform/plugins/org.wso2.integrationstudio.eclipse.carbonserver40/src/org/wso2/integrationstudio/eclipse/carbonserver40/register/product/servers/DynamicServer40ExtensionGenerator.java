...
package org.wso2.integrationstudio.eclipse.carbonserver40.register.product.servers;
...
public class DynamicServer40ExtensionGenerator {
	private static final String MASTER_TOKEN = "masterToken";
	private static final String SERVER_40_STREAM_LOC = "resources/streams/server40.xml";
	private static IDeveloperStudioLog log = Logger.getLog(Activator.PLUGIN_ID);
	private static final String SERVER_VERSION_CARBON = "carbon.server.40";
	...
	public void readProductServerExtensions(IConfigurationElement[] registeredServers,
		...
		for (IConfigurationElement elem : registeredServers) {
			...
			if (serverVersion != null && serverVersion.equals(SERVER_VERSION_CARBON)) {
				...
				try {
					InputStream inputStream = serverExtensionsRegistryUtils.generateInputStream(displayName, bundle, SERVER_40_STREAM_LOC);
					...
					extensionRegistry.addContribution(inputStream, contributor, false,
							bundleName, null, masterToken);
				} catch (IOException e) {
