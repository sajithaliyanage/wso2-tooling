...
package org.wso2.integrationstudio.eclipse.carbonserver44.register.product.servers;
...
public class DynamicServer44ExtensionGenerator {
	private static final String MASTER_TOKEN = "masterToken";
	private static final String SERVER_44_STREAM_LOC = "resources/streams/server44.xml";
	private static IDeveloperStudioLog log = Logger.getLog(Activator.PLUGIN_ID);
	private static final String SERVER_VERSION_CARBON = "carbon.server.44";
