 ...
 */
package org.wso2.integrationstudio.eclipse.registry.perspective.intro.action;
...
import org.wso2.integrationstudio.eclipse.registry.perspective.Activator;
...
public class ShowRegistryPerspective extends Action {
	...
	public void run() {
		 try {
	        	...
	        	PlatformUI.getWorkbench().showPerspective("org.wso2.integrationstudio.registry.remote.registry.pespective", window);
			} catch (Exception e) {
