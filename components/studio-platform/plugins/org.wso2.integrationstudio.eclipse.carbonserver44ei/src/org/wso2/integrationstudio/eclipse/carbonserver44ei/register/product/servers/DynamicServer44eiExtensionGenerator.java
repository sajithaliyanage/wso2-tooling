...
public class DynamicServer44eiExtensionGenerator {
	...
	private static final String SERVER_44ei_STREAM_LOC = "resources/streams/server44ei.xml";
	private static IDeveloperStudioLog log = Logger.getLog(Activator.PLUGIN_ID);
	private static final String SERVER_VERSION_CARBON = "carbon.server.44ei";
