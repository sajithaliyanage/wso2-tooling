...
//                if (view.getId().equals("org.wso2.integrationstudio.registry.remote.registry.view")){
			...
			try {
				if (!found){
    				PlatformUI.getWorkbench().getActiveWorkbenchWindow()
    							.getActivePage().showView("org.wso2.integrationstudio.registry.remote.registry.view");
				}
