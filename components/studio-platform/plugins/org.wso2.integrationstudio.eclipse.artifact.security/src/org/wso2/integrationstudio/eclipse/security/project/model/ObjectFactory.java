...
public class ObjectFactory {
    ...
    private final static QName _PolicyUUID_QNAME = new QName("", "policyUUID");
    private final static QName _ReferenceQos_QNAME = new QName("http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd", "Reference");
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "policyUUID")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    public JAXBElement<String> createPolicyUUID(String value) {
        return new JAXBElement<String>(_PolicyUUID_QNAME, String.class, null, value);
    }
    ...
    public JAXBElement<ReferenceType> createReferenceQos(ReferenceType value) {
        return new JAXBElement<ReferenceType>(_ReferenceQos_QNAME, ReferenceType.class, null, value);
    }
